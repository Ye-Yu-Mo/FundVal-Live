...
class TestHoldingsRealtime:
    def test_returns_holdings_with_quotes(self):
        ...
        mock_quote_1 = {
            "fund_code": "300750",
            "market_price": Decimal("180.50"),
            "market_growth": Decimal("2.35"),
            "market_time": "2026-06-04 14:30:00",
        }
        mock_quote_2 = {
            "fund_code": "300059",
            "market_price": Decimal("15.80"),
            "market_growth": Decimal("-1.20"),
            "market_time": "2026-06-04 14:30:00",
        }
    ...
    def test_contribution_calculation(self):
        ...
        mock_quote = {
            "fund_code": "600519",
            "market_price": Decimal("1800.00"),
            "market_growth": Decimal("3.00"),
            "market_time": "2026-06-04 14:30:00",
        }
