    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "config",
                    models.JSONField(help_text="渠道配置（webhook_url 或 email）"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cooldown_minutes",
                    models.IntegerField(default=60, help_text="冷却时间（分钟）"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "channels",
                    models.ManyToManyField(related_name="rules", to="api.notificationchannel"),
                ),
                (
                    "fund",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "growth",
                    models.DecimalField(
                        decimal_places=2, help_text="触发时的涨跌幅（%）", max_digits=10
                    ),
                ),
                (
                    "status",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["rule", "trigger_time"], name="notificatio_rule_id_56d443_idx"
            ),
        ),
    ]
