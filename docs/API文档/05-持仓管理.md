...
- **路径**: `/api/positions/operations/batch_delete/`
- **方法**: `POST`
- **认证**: 需要（管理员）
...
- **路径**: `/api/positions/{id}/clear/`
- **方法**: `DELETE`
- **认证**: 需要
- **描述**: 删除指定基金的所有操作流水并重算持仓（清仓）
